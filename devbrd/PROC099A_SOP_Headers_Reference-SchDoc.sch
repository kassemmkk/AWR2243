...
encoding utf-8
Sheet 1 1
Title "PROC099A_SOP_Headers_Reference-SchDoc"
Date "22 05 2025"
Rev ""
Comp ""
Comment1 ""
...
=EVM_orderable
$Comp
L power:GND #PWR?682F9A5F
U 1 1 682F9A5F
P 7500 4800
F 0 "GND_76" H 7500 4940 20  0000 C CNN
F 1 "GND" H 7500 4910 30  0000 C CNN
F 2 "" H 7500 4800 70  0000 C CNN
F 3 "" H 7500 4800 70  0000 C CNN
	1    7500 4800
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	6600 3500 7000 3500
Text GLabel 5800 3500 2 60 BiDi ~
PMIC_CLK
Wire Wire Line
	8100 3500 8100 3700
Wire Wire Line
	8500 3500 8100 3500
Text GLabel 8500 3500 2 60 BiDi ~
MCU_SOP2
Wire Wire Line
	7500 4200 7400 4200
Wire Wire Line
...
Wire Wire Line
	7500 6000 7500 5900
$Comp
L power:GND #PWR?682F9A5E
U 1 1 682F9A5E
P 7500 6000
F 0 "GND_77" H 7500 6140 20  0000 C CNN
F 1 "GND" H 7500 6110 30  0000 C CNN
F 2 "" H 7500 6000 70  0000 C CNN
F 3 "" H 7500 6000 70  0000 C CNN
	1    7500 6000
	1    0    0    -1  
$EndComp
$Comp
L power:GND #PWR?682F9A5D
U 1 1 682F9A5D
P 7500 7600
F 0 "GND_78" H 7500 7740 20  0000 C CNN
F 1 "GND" H 7500 7710 30  0000 C CNN
...
Wire Wire Line
	6900 6900 7000 6900
Text GLabel 5600 4200 2 60 BiDi ~
AR_PMIC_CLKOUT_SOP2
Text GLabel 5900 5400 2 60 BiDi ~
AR_SYNC_OUT_SOP1
Text GLabel 6100 6900 2 60 BiDi ~
AR_TDO_SOP0
Wire Wire Line
	10700 3300 10700 4200
$Comp
L power:+3.3V #PWR?682F9A5C
U 1 1 682F9A5C
P 10700 3300
F 0 "+3.3VD_18" H 10700 3300 20  0000 C CNN
F 1 "3.3V" H 10700 3230 30  0000 C CNN
F 2 "" H 10700 3300 70  0000 C CNN
F 3 "" H 10700 3300 70  0000 C CNN
	1    10700 3300
	1    0    0    -1  
$EndComp
Text GLabel 8500 4600 2 60 BiDi ~
MCU_SOP1
Text GLabel 8500 6200 2 60 BiDi ~
MCU_SOP0
Text Label 8130 6690 0 70 ~
750
Text Label 8130 3990 0 70 ~
750
Text Label 8130 5090 0 70 ~
750
Text Label 7090 7030 0 70 ~
10.0k
Text Label 7090 4330 0 70 ~
10.0k
Text Label 7090 5530 0 70 ~
10.0k
Text Label 7530 7390 0 70 ~
82.5k
Text Label 7530 5790 0 70 ~
82.5k
Text Label 7530 4590 0 70 ~
82.5k
Text Label 9790 7030 0 70 ~
7.87k
Text Label 9790 5530 0 70 ~
7.87k
Text Label 9790 4330 0 70 ~
7.87k
Text Label 7030 3990 0 70 ~
0
Wire Wire Line
...
FUNC - > DEFAULT VALUE FOR OUTPUTS
Text Notes 8100 3000 0    60   ~ 0
DEV MANAGEMENT -> FOR FLASHING
Wire Wire Line
	7000 4200 6900 4200
Wire Wire Line
	7000 4200 7000 4100
...
Wire Wire Line
	7500 5400 7500 5500
Text Label 9000 5400 1 70 ~
Net Class
Text Label 9000 6900 1 70 ~
Net Class
Text Label 9000 4200 1 70 ~
Net Class
Text Label 8300 3500 1 70 ~
Net Class
Text Label 8300 4600 1 70 ~
Net Class
Text Label 8300 6200 1 70 ~
Net Class
Text Notes 6800 600 0    168   ~ 12
SOP HEADERS REFERENCE
Wire Wire Line
...
U 1 1 682F9A5B
P 8100 6600
F 0 "R93" V 8110 6570 60  0000 R TNN
F 4 "750" V 1400 2000 60  0001 C CNN "ValueDisplayed"
	1    8100 6600
	0    -1   -1   0
$EndComp
$Comp
...
U 1 1 682F9A5A
P 9900 6900
F 0 "R92" H 9790 6930 60  0000 L BNN
F 4 "7.87k" V 1400 2000 60  0001 C CNN "ValueDisplayed"
	1    9900 6900
	1    0    0    -1
$EndComp
$Comp
...
U 1 1 682F9A59
P 9900 5400
F 0 "R95" H 9790 5430 60  0000 L BNN
F 4 "7.87k" V 1400 2000 60  0001 C CNN "ValueDisplayed"
	1    9900 5400
	1    0    0    -1
$EndComp
...
U 1 1 682F9A58
P 9900 4200
F 0 "R99" H 9790 4230 60  0000 L BNN
F 4 "7.87k" V 1400 2000 60  0001 C CNN "ValueDisplayed"
	1    9900 4200
	1    0    0    -1
$EndComp
...
U 1 1 682F9A57
P 7000 3900
F 0 "R97" V 7010 3870 60  0000 R TNN
...
U 1 1 682F9A56
P 10300 5900
F 0 "P2" V 10000 5800 60  0000 R BNN
	1    10300 5900
	0    1   -1   0
$EndComp
$Comp
...
U 1 1 682F9A55
P 10300 4700
F 0 "P3" V 10000 4600 60  0000 R BNN
	1    10300 4700
	0    1   -1   0
$EndComp
$Comp
...
U 1 1 682F9A54
P 10300 7500
F 0 "P4" V 10000 7400 60  0000 R BNN
	1    10300 7500
	0    1   -1   0
$EndComp
$Comp
L CMP-0026542-2 R101
U 1 1 682F9A53
P 8100 3900
F 0 "R101" V 8110 3870 60  0000 R TNN
F 4 "750" V 1400 2000 60  0001 C CNN "ValueDisplayed"
	1    8100 3900
	0    -1   -1   0
$EndComp
...
U 1 1 682F9A52
P 8100 5000
F 0 "R112" V 8110 4970 60  0000 R TNN
F 4 "750" V 1400 2000 60  0001 C CNN "ValueDisplayed"
	1    8100 5000
	0    -1   -1   0
$EndComp
...
U 1 1 682F9A51
P 7200 6900
F 0 "R89" H 7090 6930 60  0000 L BNN
...
U 1 1 682F9A50
P 7200 4200
F 0 "R98" H 7090 4230 60  0000 L BNN
F 4 "10.0k" V 1400 2000 60  0001 C CNN "ValueDisplayed"
	1    7200 4200
	1    0    0    -1
$EndComp
$Comp
L CMP-0025958-3 R113
U 1 1 682F9A4F
P 7200 5400
F 0 "R113" H 7090 5430 60  0000 L BNN
F 4 "10.0k" V 1400 2000 60  0001 C CNN "ValueDisplayed"
	1    7200 5400
	1    0    0    -1
$EndComp
...
U 1 1 682F9A4E
P 7500 7300
F 0 "R88" V 7510 7270 60  0000 R TNN
F 4 "82.5k" V 1400 2000 60  0001 C CNN "ValueDisplayed"
	1    7500 7300
	0    -1   -1   0
$EndComp
$Comp
...
U 1 1 682F9A4D
P 7500 5700
F 0 "R96" V 7510 5670 60  0000 R TNN
F 4 "82.5k" V 1400 2000 60  0001 C CNN "ValueDisplayed"
	1    7500 5700
	0    -1   -1   0
$EndComp
$Comp
L CMP-0026574-2 R114
U 1 1 682F9A4C
P 7500 4500
F 0 "R114" V 7510 4470 60  0000 R TNN
F 4 "82.5k" V 1400 2000 60  0001 C CNN "ValueDisplayed"
	1    7500 4500
	0    -1   -1   0
$EndComp
